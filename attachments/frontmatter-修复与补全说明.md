...
|---|---|---|---|---|
| elevenlabs | 语法修复 | [DESIGN.md](normalized/elevenlabs/DESIGN.md) | [YAML](frontmatter/elevenlabs.yaml) | [sources](sources/elevenlabs.json) |
| raycast | 语法修复 | [DESIGN.md](normalized/raycast/DESIGN.md) | [YAML](frontmatter/raycast.yaml) | [sources](sources/raycast.json) |
| supabase | 语法修复 | [DESIGN.md](normalized/supabase/DESIGN.md) | [YAML](frontmatter/supabase.yaml) | [sources](sources/supabase.json) |
| kraken | 缺失补全 | [DESIGN.md](normalized/kraken/DESIGN.md) | [YAML](frontmatter/kraken.yaml) | [sources](sources/kraken.json) |
| lamborghini | 缺失补全 | [DESIGN.md](normalized/lamborghini/DESIGN.md) | [YAML](frontmatter/lamborghini.yaml) | [sources](sources/lamborghini.json) |
| lovable | 缺失补全 | [DESIGN.md](normalized/lovable/DESIGN.md) | [YAML](frontmatter/lovable.yaml) | [sources](sources/lovable.json) |
| mastercard | 缺失补全 | [DESIGN.md](normalized/mastercard/DESIGN.md) | [YAML](frontmatter/mastercard.yaml) | [sources](sources/mastercard.json) |
| runwayml | 缺失补全 | [DESIGN.md](normalized/runwayml/DESIGN.md) | [YAML](frontmatter/runwayml.yaml) | [sources](sources/runwayml.json) |
| sanity | 缺失补全 | [DESIGN.md](normalized/sanity/DESIGN.md) | [YAML](frontmatter/sanity.yaml) | [sources](sources/sanity.json) |
| spotify | 缺失补全 | [DESIGN.md](normalized/spotify/DESIGN.md) | [YAML](frontmatter/spotify.yaml) | [sources](sources/spotify.json) |
| starbucks | 缺失补全 | [DESIGN.md](normalized/starbucks/DESIGN.md) | [YAML](frontmatter/starbucks.yaml) | [sources](sources/starbucks.json) |
| tesla | 缺失补全 | [DESIGN.md](normalized/tesla/DESIGN.md) | [YAML](frontmatter/tesla.yaml) | [sources](sources/tesla.json) |
| theverge | 缺失补全 | [DESIGN.md](normalized/theverge/DESIGN.md) | [YAML](frontmatter/theverge.yaml) | [sources](sources/theverge.json) |
...
上面是解释示意，不是可应用patch。真实完整patch在[elevenlabs.patch](patches/elevenlabs.patch)。
...
同样改为`description: >-`后缩进完整原文。真实patch：[supabase.patch](patches/supabase.patch)。
...
真实patch：[raycast.patch](patches/raycast.patch)。
